"use strict";
const _i = ['Phigros4', [1, 14, 514], 1611795955, 1652747710];
const urls = {
...
class ClickEvent1 {
	...
	static getClickPerfect(offsetX, offsetY) {
		return new ClickEvent1(offsetX, offsetY, "rgba(255,255,255,1)", 4, "#ffffff");
	}
	static getClickGreat(offsetX, offsetY) {
		return new ClickEvent1(offsetX, offsetY, "rgba(255,255,255,1)", 4, "#ffffff");
	}
	static getClickGood(offsetX, offsetY) {
		return new ClickEvent1(offsetX, offsetY, "rgba(255,255,255,0.99)", 3, "#ffffff");
	}
}
class ClickEvent2 {
	constructor(offsetX, offsetY, n1, n2) {
...
window.onload = async function() {
	...
	await (async function() {
		...
		await Promise.all((obj => {
			...
			Pause: "src/Pause.png",
			clickRaw: "src/v1/clickRaw.png",
			clickRaw2: "src/v1/clickRaw2.png",
			Tap: "src/v1/Tap.png",
			Tap2: "src/v1/Tap2.png",
			TapHL: "src/v1/TapHL.png",
			Drag: "src/v1/Drag.png",
			DragHL: "src/v1/DragHL.png",
			HoldHead: "src/v1/HoldHead.png",
			HoldHeadHL: "src/v1/HoldHeadHL.png",
			Hold: "src/v1/Hold.png",
			HoldHL: "src/v1/HoldHL.png",
			HoldEnd: "src/v1/HoldEnd.png",
			Flick: "src/v1/Flick.png",
			FlickHL: "src/v1/FlickHL.png",
		...
		res["Clicks"]["rgba(255,255,255,1)"] = await qwqImage(res["clickRaw"], "rgba(255,255,255,1)"); //#fce491
		res["Clicks"]["rgba(255,255,255,1)"] = await qwqImage(res["clickRaw"], "rgba(255,255,255,1)"); //#97f79d
		res["Clicks"]["rgba(255,255,255,0.99)"] = await qwqImage(res["clickRaw2"], "rgba(255,255,255,0.99)"); //#9ed5f3
