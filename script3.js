"use strict";
const _i = ['Phigros3', [1, 14, 514], 1611795955, 1652747710];
const urls = {
...
class ClickEvent1 {
	...
	static getClickPerfect(offsetX, offsetY) {
		return new ClickEvent1(offsetX, offsetY, "rgba(246,158,111,0.8823529)", 4, "#ffeca0");
	}
...
window.onload = async function() {
	...
	await (async function() {
		...
		await Promise.all((obj => {
			...
			Pause: "src/Pause.png",
			clickRaw: "src/v0/clickRaw.png",
			Tap: "src/v0/Tap.png",
			Tap2: "src/v0/Tap2.png",
			TapHL: "src/v0/TapHL.png",
			Drag: "src/v0/Drag.png",
			DragHL: "src/v0/DragHL.png",
			HoldHead: "src/v0/HoldHead.png",
			HoldHeadHL: "src/v0/HoldHeadHL.png",
			Hold: "src/v0/Hold.png",
			HoldHL: "src/v0/HoldHL.png",
			HoldEnd: "src/v0/HoldEnd.png",
			Flick: "src/v0/Flick.png",
			FlickHL: "src/v0/FlickHL.png",
		...
		res["Clicks"]["rgba(246,158,111,0.8823529)"] = await qwqImage(res["clickRaw"], "rgba(246,158,111,0.8823529)"); //#fce491
...
function qwqdraw1(now) {
	...
	for (const i of clickEvents1) { //绘制打击特效1
		const tick = (now - i.time) / i.duration;
		ctxos.globalAlpha = 1;
		ctxos.setTransform(...imgFlip(noteScale * 10, 0, 0, noteScale * 10, i.offsetX, i.offsetY)); //缩放
